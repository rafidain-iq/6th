...
window.getInitialData = function () {
  const DATA = {
    ...
    "2025-10-02": { tasks: [], exams: [ { subject: "شامل", title: "امتحانات شاملة + إسلامية", questions: [] } ] },
    "2025-10-03": {
      tasks: [
        { subject: "أحياء", content: "Chapter 3 - Lecture 13 & 14", hours: 2 },
        { subject: "عربي", content: "أسلوب التقديم والتأخير - Lecture 3 & 4", hours: 2 }
      ],
      exams: [
        {
          subject: "انكليزي",
    ...
    "2025-10-04": {
      tasks: [
        ...
        { subject: "رياضيات", content: "مراجعة مسائل", hours: 1 }
      ],
      exams: [
        {
          subject:"أحياء",
    ...
    "2025-10-07": {
      tasks:[
        {subject:"عربي", content:"أسلوب التوكيد - Lecture 1 & 2", hours:2},
        {subject:"أحياء", content:"Chapter 3 - Lecture 19 & 20", hours:2},
        {subject:"فيزياء", content:"مراجعة الفصل 3 - Lesson 1 & 2", hours:1}
      ],
      exams:[
        {
          subject:"انكليزي",
	...
	"2025-10-11": {
      tasks: [
        { subject: "إنكليزي", content: "Unit 4 - Lecture 1 & 2", hours: 2 },
    ...
    "2025-10-12": {
      tasks: [
        { subject: "إنكليزي", content: "Unit 4 - Lecture 3 & 4", hours: 2 },
    ...
    "2025-10-13": {
      tasks: [
        { subject: "إنكليزي", content: "Unit 4 - Lecture 5 & 6", hours: 2 },
    ...
    "2025-10-14": {
      tasks: [
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 },
        { subject: "أحياء", content: "Chapter 4 - Lecture 3 & 4", hours: 2 },
        { subject: "فيزياء", content: "مراجعة الفصل 3 - Lesson 3 & 4", hours: 1 }
      ],
      exams: []
    },
    "2025-10-15": {
    ...
    "2025-10-17": {
      tasks: [
        { subject: "أحياء", content: "Chapter 4 - Lecture 7 & 8", hours: 2 },
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 }
      ],
      exams: []
    },
    ...
    "2025-10-21": {
      tasks: [
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 },
        { subject: "أحياء", content: "Chapter 4 - Lecture 9 & 10", hours: 2 },
        { subject: "فيزياء", content: "مراجعة الفصل 3 - Lesson 5 & 6", hours: 1 }
      ],
      exams: []
    },
    "2025-10-22": {
      tasks: [
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 },
        { subject: "أدب عربي", content: "مراجعة ميخائيل نعيمة", hours: 2 },
        { subject: "أحياء", content: "Chapter 4 - Lecture 11 & 12", hours: 2 }
      ],
      exams: []
    },
    "2025-10-23": {
    ...
    "2025-10-24": {
      tasks: [
        { subject: "أحياء", content: "Chapter 4 - Lecture 13 & 14", hours: 2 },
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 }
      ],
      exams: []
    },
    "2025-10-25": {
      tasks: [
        ...
        { subject: "كيمياء", content: "Chapter 4 - Lecture 13 & 14", hours: 2 },
        { subject: "رياضيات", content: "مراجعة مسائل", hours: 1 }
      ],
      exams: []
    },
    "2025-10-26": {
      tasks: [
        ...
        { subject: "أحياء", content: "Chapter 4 - Lecture 15 & 16", hours: 2 }
      ],
      exams: []
    },
    "2025-10-27": {
      tasks: [
        ...
        { subject: "كيمياء", content: "Chapter 4 - Lecture 15 & 16", hours: 2 }
      ],
      exams: []
    },
    "2025-10-28": {
      tasks: [
        { subject: "أحياء", content: "Chapter 4 - Lecture 17 & 18", hours: 2 },
        { subject: "عربي", content: "مراجعة أسلوب التوكيد", hours: 2 },
        { subject: "فيزياء", content: "مراجعة الفصل 3 - Lesson 11 & 12", hours: 1 }
      ],
      exams: []
    },
    "2025-10-29": {
      tasks: [
        { subject: "رياضيات", content: "مراجعة مسائل", hours: 1 },
        { subject: "كيمياء", content: "Chapter 4 - Lecture 17 & 18", hours: 2 }
      ],
      exams: []
    },
    "2025-10-30": {
